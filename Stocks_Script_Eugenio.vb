' Program to determine the percentage change of stocks. 
' Eugenio Gallastegui 
Sub GenStockData()


    ' Whith this code I apply the Loop through all sheets. 
    ' ----------------------------------------------------------------------------------
Dim WS As Worksheet
    ...
    WS.Activate
        ...
        '-------------------------------------------------------------------------------
        ' Determine the Last Row: As we are working through different worksheets,
        'and the number of rows is different in each case, it is better for us to use this formula. 
        LastRow = WS.Cells(Rows.Count, 1).End(xlUp).Row 
        '--------------------------------------------------------------------------------

        '--------------------------------------------------------------------------------
        '(1) Create Headings For Summary
        ...
        '--------------------------------------------------------------------------------
        '(2) Create and set the Variables to Hold Values
        ...
        '--------------------------------------------------------------------------------
         ' (3) Loop through all ticker symbol
        
        For i = 2 To LastRow
         ' If the ticker name changes, then...
        ...
        '--------------------------------------------------------------------------------
        ' (5) Set Greatest % Increase, % Decrease, and Total Volume
        Cells(2, Column + 14).Value = "Greatest % Increase"
        Cells(3, Column + 14).Value = "Greatest % Decrease"
        Cells(4, Column + 14).Value = "Greatest Total Volume"
        Cells(1, Column + 15).Value = "Ticker"
        Cells(1, Column + 16).Value = "Value"
        ' (5.1) Look through each rows to find the greatest value and its associate ticker
